...
```{r bru_traffic, fig.align='center', fig.cap=paste('Air Traffic Evolution at', bru)}
...
```{r bru_average, fig.align='center', fig.cap=paste('Average Daily Flights at', bru)}
...
```{r div_map, fig.align='center', fig.cap=paste('Map of all the diverted flights headed to', bru)}
...
```{r eu_traffic, fig.align='center', fig.cap='European Air Traffic Evolution'}
ggplot(data = eu) +
...
```{r bcn_traffic, fig.align='center', fig.cap=paste('Air Traffic Evolution at', bcn)}
...
```{r nearby_traffic, fig.align='center', fig.cap='Air Traffic Evolution in Nearby Airports', fig.subcap=nearby, fig.ncol=1}
for (airport in nearby) {
	print(ddr.stimes(data$real$flights, airport, event))
}
```
...
```{r av_flights, fig.align='center', fig.cap='Average Daily Flights in Nearby Airports'}
ggplot(data = NULL, aes(y = N.x + N.y)) +
...
```{r av_delays, fig.align='center', fig.cap='Average Daily Delays', fig.subcap=nearby, fig.ncol=1}
...
```{r av_dep, fig.align='center', fig.cap='Average Daily Departure Delays'}
...
```{r av_arr, fig.align='center', fig.cap='Average Daily Arrival Delays'}
...
```{r fucked, fig.align='center', fig.cap='Most Affected Airlines'}
