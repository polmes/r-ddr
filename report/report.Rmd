...
ddr.times(data$real$flights, nearby[1], event, group = 'nearby')
ddr.times(data$real$flights, nearby[1], event, group = 'nearby')
ddr.times(data$real$flights, nearby[2], event, group = 'nearby')
ddr.times(data$real$flights, nearby[4], event, group = 'nearby')
ddr.times(data$real$flights, nearby[5], event, group = 'nearby')
```
